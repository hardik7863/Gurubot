...
def main():
    ...
    st.write("Hi! I'm Gurubot, your personal career counseling bot. Ask your queries in the text box below and hit enter. If and when you are ready to take our personality test, type \"start my test\" and you're good to go!")
    ...
    st.text_area("GuruBot:", value=ans, height=100, max_chars=None)
